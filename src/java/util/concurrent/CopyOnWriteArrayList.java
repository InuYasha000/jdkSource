...
public class CopyOnWriteArrayList<E>
    ...
    //储存元素的地方，只能通过getArray/setArray访问,transient和volatile重点
    ...
    public CopyOnWriteArrayList(Collection<? extends E> c) {
        Object[] elements;
        if (c.getClass() == CopyOnWriteArrayList.class)//传入参数c是CopyOnWriteArrayList类型，直接赋值，不新建
     ...
     */
    //把toCopyIn的元素拷贝给当前CopyOnWriteArrayList。
